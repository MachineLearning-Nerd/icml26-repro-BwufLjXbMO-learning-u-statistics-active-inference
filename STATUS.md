...
- Current phase: claim_4_attempt_2_inconclusive_authoritative_provenance
...
- Claim 4: inconclusive after two authoritative source/provenance audits; no author executable, supplement, ACS version/extraction, split, seeds, or trial outputs were recovered. The paper assigns its roughly 60% saving to classical, not uniform; no proxy was represented as a reproduction.
- Claim 5–6: unverified
- Next action: Claim 4 Attempt 3 — independent ACS primary-provenance and protocol-recovery audit; then one documented falsification attempt only if the literal uniform-comparison wording remains testable.
