...
- Current phase: claim_6_attempt_1_inconclusive
...
- Claim 6: Attempt 1 inconclusive. The accepted source supports the 20%-versus-classical and 10%-versus-uniform wording, but no political-bias snapshot, LLM outputs, executable, configuration, seeds, or 3,000-trial outputs are released. The swapped-comparator negative control is unsupported.
- Next action: Claim 6 Attempt 2 — authoritative dataset and author-release search.
