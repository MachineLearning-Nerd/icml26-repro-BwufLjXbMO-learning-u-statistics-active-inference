...
- Claim 6: Attempts 1–3 inconclusive. Independent archive/dataset-provenance audit confirms the selected source documents the GPT-3.5/GPT-4, 3,000-trial protocol but releases no executable/data/configuration/trial assets; related-work arXiv metadata is not a selected-paper release. No proxy was run. See `outputs/claim6_attempt3_audit.md`.
- Next action: Claim 6 literal-source falsification attempt.
